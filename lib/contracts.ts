...
export const CONTRACT_ADDRESSES = {
  // Updated from deployment-base-sepolia.json (2025-12-04T16:49:34.017Z)
  BTC1USD:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0x5Ffa9c405B131cfd3c0ABa95C31fABedfd0Af861",
  BTC1USD_CONTRACT:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0x5Ffa9c405B131cfd3c0ABa95C31fABedfd0Af861",
  VAULT:
    process.env.NEXT_PUBLIC_VAULT_CONTRACT ||
    "0xCc4522fe8185e79528c2Cd9B153d6c4291a018fE",
  CHAINLINK_BTC_ORACLE:
    process.env.NEXT_PUBLIC_PRICE_ORACLE_CONTRACT ||
    "0xc9FF828226eA4Dc900FF03008173AEFeE358312C",
  ...
  WEEKLY_DISTRIBUTION:
    ...
    "0x918280Bc0777FE1A39e7F1748bf12be8Ad8Da191",
  MERKLE_DISTRIBUTOR:
    process.env.NEXT_PUBLIC_MERKLE_DISTRIBUTOR_CONTRACT ||
    "0x5D4964584B2B478e2D42CeEb8860C4eaeE4f41d2",
  ENDOWMENT_MANAGER:
    process.env.NEXT_PUBLIC_ENDOWMENT_MANAGER_CONTRACT ||
    "0x27C43c69147f293834cC909E9F8C1Bf2E68B08BE",
  PROTOCOL_GOVERNANCE:
    process.env.NEXT_PUBLIC_PROTOCOL_GOVERNANCE_CONTRACT ||
    "0xF879Ed140829913fC473836a5546c182976A6d89",
  GOVERNANCE_DAO:
    process.env.NEXT_PUBLIC_DAO_CONTRACT ||
    "0x1520d3635834517BcFb3996d3443e56dF2ED85EC",
  PROXY_ADMIN:
  ...
  DEV_WALLET:
    ...
    "0xC90779c0d5e188C2d5357d8256E04CFc80b34526",
  ENDOWMENT_WALLET:
    process.env.NEXT_PUBLIC_ENDOWMENT_WALLET_CONTRACT ||
    "0x57F7085B030FcBa707F8Ffff4207f14524dB092C",
  MERKLE_FEE_COLLECTOR:
    process.env.NEXT_PUBLIC_MERKLE_FEE_COLLECTOR_CONTRACT ||
    "0x56bA2CB3f50BD4D1A4BEf192Be508BD1D4dbbd3A",
