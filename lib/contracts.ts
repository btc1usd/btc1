...
export const CONTRACT_ADDRESSES = {
  // Updated from deployment-base-sepolia.json (2025-11-05T01:53:59.310Z)
  BTC1USD:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0x3D84Ef48da771975C056b0846d18098465d9A2a9",
  BTC1USD_CONTRACT:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0x3D84Ef48da771975C056b0846d18098465d9A2a9",
  VAULT:
    process.env.NEXT_PUBLIC_VAULT_CONTRACT ||
    "0x1a90e7eA069047D68b39e6eC5E3D0E112273C8B5",
  CHAINLINK_BTC_ORACLE:
    process.env.NEXT_PUBLIC_PRICE_ORACLE_CONTRACT ||
    "0x0ADC2d7c042A3157080753f4f838714B19DBCA1B",
  ...
  WEEKLY_DISTRIBUTION:
    ...
    "0x8B90c9481b4D119b5C3c5C5801590A37657794D4",
  MERKLE_DISTRIBUTOR:
    process.env.NEXT_PUBLIC_MERKLE_DISTRIBUTOR_CONTRACT ||
    "0x6a01D5Fd238350D2F2522B8055921Da213e41511",
  ENDOWMENT_MANAGER:
    process.env.NEXT_PUBLIC_ENDOWMENT_MANAGER_CONTRACT ||
    "0xC858e804EDe9003559a9CEE601B78790D0EF4255",
  PROTOCOL_GOVERNANCE:
    process.env.NEXT_PUBLIC_PROTOCOL_GOVERNANCE_CONTRACT ||
    "0xB6Ff09Ad34364d81CE332b1248fd9d995D72D7B3",
  GOVERNANCE_DAO:
    process.env.NEXT_PUBLIC_DAO_CONTRACT ||
    "0x3535aa1f5552d5eFfDDE00f82bE09F444C564737",
  PROXY_ADMIN:
  ...
  DEV_WALLET:
    ...
    "0xab204105A2483c7cFD6Eb02c72C2511b2aEAFC09",
  ENDOWMENT_WALLET:
    process.env.NEXT_PUBLIC_ENDOWMENT_WALLET_CONTRACT ||
    "0xAf5313Bd27f44f8EeD691969aBf3c794257Ddc31",
  MERKLE_FEE_COLLECTOR:
    process.env.NEXT_PUBLIC_MERKLE_FEE_COLLECTOR_CONTRACT ||
    "0x01775cEE102B8E72DF511154410896A59B57f657",
