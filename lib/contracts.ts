...
export const CONTRACT_ADDRESSES = {
  // Updated from deployment-base-sepolia.json (2025-11-07T07:03:12.341Z)
  BTC1USD:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0xf9FB909C5841B067D3931cc5413faa08c76f39e4",
  BTC1USD_CONTRACT:
    process.env.NEXT_PUBLIC_BTC1USD_CONTRACT ||
    "0xf9FB909C5841B067D3931cc5413faa08c76f39e4",
  VAULT:
    process.env.NEXT_PUBLIC_VAULT_CONTRACT ||
    "0x73D7a6c6eB4989155329f0F1Ccf8d48aBEA2b36d",
  CHAINLINK_BTC_ORACLE:
    process.env.NEXT_PUBLIC_PRICE_ORACLE_CONTRACT ||
    "0x4A95E2f8E91DBfF9f1AfBde9c0fDFe75B834c907",
  ...
  WEEKLY_DISTRIBUTION:
    ...
    "0x369C0E679446c99b33Dd5c17aa7451b8c9a8eea9",
  MERKLE_DISTRIBUTOR:
    process.env.NEXT_PUBLIC_MERKLE_DISTRIBUTOR_CONTRACT ||
    "0x56718c78BDd65cfa9f2CF03413F29245C41E0c51",
  ENDOWMENT_MANAGER:
    process.env.NEXT_PUBLIC_ENDOWMENT_MANAGER_CONTRACT ||
    "0x4f66C57fC65a925aE2a59600EcD8253BD83c3F64",
  PROTOCOL_GOVERNANCE:
    process.env.NEXT_PUBLIC_PROTOCOL_GOVERNANCE_CONTRACT ||
    "0x8BEBb8D4A815A7A79997B8049a18Cf0c525F8BC9",
  GOVERNANCE_DAO:
    process.env.NEXT_PUBLIC_DAO_CONTRACT ||
    "0x9F6dF8977abe6100F5517165a05E68661AD4DAF7",
  PROXY_ADMIN:
  ...
  DEV_WALLET:
    ...
    "0x08AcBF0679A24dDcF04f93F255Fc5d4E08a8AE4d",
  ENDOWMENT_WALLET:
    process.env.NEXT_PUBLIC_ENDOWMENT_WALLET_CONTRACT ||
    "0x6BFb7FFCC71dE16Cf6a812d1b9F213E871a6904C",
  MERKLE_FEE_COLLECTOR:
    process.env.NEXT_PUBLIC_MERKLE_FEE_COLLECTOR_CONTRACT ||
    "0xAc1B24F5CB1C17a97E14306f1A3F03BD38674Ad5",
